...
export function resolveNextPending(input: NextVisitInput, now: Date): ResolvedNextPending | undefined {
  ...
  return {
    ...
    reminderLeadDays: clampLeadDays(input.reminderLeadDays ?? 0, daysBetween(now, input.date)),
  };
}
